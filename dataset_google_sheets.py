...
def save_results(sheetname, results):
    global gc
    doc = gc.open_by_url('https://docs.google.com/spreadsheets/d/1vcFgJ2feBJCg8SGuZLdkbaYU8q2XS0dqqB-vUepp1D8/edit#gid=0')
    worksheet = doc.add_worksheet(sheetname, 1, 1)
    worksheet.append_row(['ID','문제','preprocessed','extracted','lists','extracted','equations','match','distance','match','template','assignments','statements','비슷한문제ID','풀이과정','정답','실행시간'])
